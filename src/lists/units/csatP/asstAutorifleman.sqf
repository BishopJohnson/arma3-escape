...
if (Escape_Csat_Pacific_Use_Camo) then
{
    switch (_map) do
    {
        ...
        case LIVONIA_KEY:
        {
            ...
            _tracerMag = "100Rnd_580x42_ghex_Mag_Tracer_F";
        ...
        default
        {
            ...
            _tracerMag = "100Rnd_580x42_hex_Mag_Tracer_F";
...
else
{
    ...
    _tracerMag = "100Rnd_580x42_Mag_Tracer_F";
    _uniform = "U_O_T_Soldier_F";
    _vest = "V_TacChestrig_oli_F";
    _helmet = "H_HelmetO_ghex_F";
    _backpack = "B_Carryall_ghex_OTAAR_AAR_F";
...
_unit addItemToBackpack _tracerMag;
