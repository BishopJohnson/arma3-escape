...
if (Escape_Csat_Pacific_Use_Camo) then
{
    switch (_map) do
    {
        ...
        case LIVONIA_KEY:
        {
            _weaponP = "srifle_DMR_07_ghex_F";
            _optic = "optic_DMS_ghex_F";
...
for "_i" from 1 to 3 do {_unit addItemToUniform "20Rnd_650x39_Cased_Mag_F";};
