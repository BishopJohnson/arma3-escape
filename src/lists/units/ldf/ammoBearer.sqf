...
_unit addBackpack "B_Carryall_eaf_IEAmmo_F";
...
for "_i" from 1 to 8 do {_unit addItemToBackpack "30Rnd_65x39_caseless_msbs_mag";};
_unit addItemToBackpack "200Rnd_65x39_cased_Box_Red";
...
for "_i" from 1 to 3 do {_unit addItemToBackpack "6Rnd_12Gauge_Pellets";};
for "_i" from 1 to 3 do {_unit addItemToBackpack "6Rnd_12Gauge_Slug";};
