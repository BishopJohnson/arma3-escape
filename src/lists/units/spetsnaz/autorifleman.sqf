...
if (Escape_Nato_Use_Camo) then
{
    ...
    switch (_map) do
    {
        case TANOA_KEY:
        {
            _weaponP = "arifle_RPK12_lush_F";
            _mag = "75rnd_762x39_AK12_Lush_Mag_F";
        ...
        default
        {
            _weaponP = "arifle_RPK12_arid_F";
            _mag = "75rnd_762x39_AK12_Arid_Mag_F";
...
else
{
    ...
    {
        _weaponP = "arifle_RPK12_F";
        _mag = "75rnd_762x39_AK12_Mag_F";
