...
if (Escape_Nato_Use_Camo) then
{
    ...
    switch (_map) do
    {
        case TANOA_KEY:
        {
            _weaponP = "arifle_AK12_lush_F";
            _mag = "30rnd_762x39_AK12_Lush_Mag_F";
            _optic = "optic_Arco_AK_lush_F";
            _bipod = "bipod_02_F_lush";
        ...
        default
        {
            ...
            _optic = "optic_Arco_AK_arid_F";
            _bipod = "bipod_02_F_arid";
