...
[
	[ 
		...
		["Flag_AAF_F",[-17.769,12.8774,0],0,1,0,[0,0],"","",true,false], 
...
/*  [object, position, azimuth, fuel, damage, orientation, varName, init, simulated, asl] */
    ["I_Truck_02_box_F",[13.4011,-21.6802,0.114967],270,random [0.25, 0.5, 1],0,[0,0],"","",true,false], // Util
	["I_MRAP_03_hmg_F",[21.5132,14.207,0.148828],270,random [0.25, 0.45, 0.9],random [0, 0.1, 0.3],[0,0],"","this setVehicleAmmo random [0.2, 0.5, 1];",true,false],               // Port 1
	["I_APC_Wheeled_03_cannon_F",[-22.1689,-9.99365,0.112128],90,random [0.15, 0.4, 0.7],random [0.6, 0.65, 0.7],[0,-0],"","this setVehicleAmmo random [0.2, 0.5, 1];",true,false] // Port 2
];

// The vehicles that may spawn in the different car ports
_util = ["I_Truck_02_box_F", "I_Truck_02_medical_F", "I_Truck_02_fuel_F", "I_Truck_02_ammo_F"];
_port1 = ["I_MRAP_03_hmg_F", "I_MRAP_03_gmg_F", "I_MRAP_03_F"];
_port2 = ["I_MRAP_03_hmg_F", "I_MRAP_03_gmg_F", "I_APC_Wheeled_03_cannon_F"];
