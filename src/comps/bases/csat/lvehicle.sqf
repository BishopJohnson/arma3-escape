...
[
    [ 
		...
		["Flag_CSAT_F",[16.1033,-18.6108,0],180,1,0,[0,0],"","",true,false], 
...
/*  [object, position, azimuth, fuel, damage, orientation, varName, init, simulated, asl] */
    ["O_Truck_03_repair_F",[7.44751,-19.2725,0.114967],270,random [0.25, 0.5, 1],0,[0,0],"","",true,false], // Util
	["O_MRAP_02_hmg_F",[-20.3137,12.146,0.148828],90,random [0.25, 0.45, 0.9],random [0, 0.1, 0.3],[0,-0],"","this setVehicleAmmo random [0.2, 0.5, 1];",true,false],             // Port 1
	["O_APC_Wheeled_02_rcws_v2_F",[17.8669,13.8052,0.112128],270,random [0.15, 0.4, 0.7],random [0.6, 0.65, 0.7],[0,0],"","this setVehicleAmmo random [0.2, 0.5, 1];",true,false] // Port 2
];

// The vehicles that may spawn in the different car ports
_util = ["O_Truck_03_repair_F", "O_Truck_03_medical_F", "O_Truck_03_fuel_F", "O_Truck_03_ammo_F"];
_port1 = ["O_MRAP_02_hmg_F", "O_MRAP_02_gmg_F", "O_MRAP_02_F", "O_LSV_02_AT_F", "O_LSV_02_armed_F", "O_LSV_02_unarmed_F"];
_port2 = ["O_MRAP_02_hmg_F", "O_MRAP_02_gmg_F", "O_LSV_02_AT_F", "O_LSV_02_armed_F", "O_APC_Wheeled_02_rcws_v2_F"];
